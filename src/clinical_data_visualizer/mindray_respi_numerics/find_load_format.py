...
def main(patient_options: dict, database_options_specific: dict | None) -> pd.DataFrame:
    """Load and process MindRay Respi Numerics data."""
    return MindRayRespiNumericsDataSource.main(patient_options, database_options_specific)
