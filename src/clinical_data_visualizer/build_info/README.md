...
This folder contains the PyInstaller configuration and build scripts for creating a standalone executable of Clinical Data Visualizer.
...
# macOS Intel
pyinstaller src/clinical_data_visualizer/build_info/core_api.spec --clean --distpath builded_app/macOS_intel

# Linux
pyinstaller src/clinical_data_visualizer/build_info/core_api.spec --clean --distpath builded_app/linux

# Windows
pyinstaller src/clinical_data_visualizer/build_info/core_api.spec --clean --distpath builded_app/windows
```
...
- `clinical_data_visualizer` - This package
